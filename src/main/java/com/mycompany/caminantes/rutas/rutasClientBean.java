...
import com.mycompany.caminantes.json.RutaReader;
import com.mycompany.caminantes.json.RutaWriter;
...
public class rutasClientBean {
    ...
    public void addRuta() {
        ...
        r.setOrganizador(bean.getOrganizador());
        target.register(RutaWriter.class)
                .request()
